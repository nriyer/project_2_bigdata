...
kmeans_iyer(test1,4)
#Within cluster sum of squares by cluster:
 # [1]  29.01729  22.01589  36.44135 292.61901
#(between_SS / total_SS =  94.3 %)

#K=5
kmeans_iyer(train1,5)
#K-means clustering with 5 clusters of sizes 385, 871, 341, 1752, 713

#Within cluster sum of squares by cluster:
 # [1]  15.35515  21.43344  34.77083 184.59643  30.26522
#(between_SS / total_SS =  97.3 %)


kmeans_iyer(test1,5)
# Within cluster sum of squares by cluster:
#[1]  21.93027 104.65162  56.99966  23.40684  30.18281
...
# Within cluster sum of squares by cluster:
#[1] 126.228287   7.838349   2.477561  30.860839  23.627896  54.666456   2.586484
#(between_SS / total_SS =  98.5 %)

kmeans_iyer(test1,7)
#Within cluster sum of squares by cluster:
#  [1] 50.952388 28.594261 29.129220  7.422338 15.848822 20.866264 10.766227
...
#K-means clustering with 4 clusters of sizes 1171, 1022, 2681
# Within cluster sum of squares by cluster:
...
kmeans_iyer(test2,3)
# Within cluster sum of squares by cluster:
#[1]  47.75000 339.18316  28.58319
#(between_SS / total_SS =  79.1 %)

#K=5
kmeans_iyer(train2,5)
#K-means clustering with 5 clusters of sizes 1148, 1498, 817, 383, 1028

# Within cluster sum of squares by cluster:
#[1]  23.79893 221.06664  35.35659  37.42691  68.16516
#(between_SS / total_SS =  97.0 %)


kmeans_iyer(test2,5)
# Within cluster sum of squares by cluster:
# [1]  24.80585 163.17765 135.50818  11.01581   9.60811
...
# Within cluster sum of squares by cluster:
#[1] 22.75942 17.64033 22.72019 29.29340 36.58788 30.13918 20.22570
#(between_SS / total_SS =  99.1 %)

kmeans_iyer(test2,7)
#Within cluster sum of squares by cluster:
 # [1] 12.48337 15.92782 21.73279 14.26809 23.33082 13.19411 19.67325
#(between_SS / total_SS =  99.1 %)
...
#K-means clustering with 5 clusters of sizes 1313, 973, 1427, 758, 1215

# Within cluster sum of squares by cluster:
#[1]  30.87564  41.55789 162.50513  78.01716  29.35461
#(between_SS / total_SS =  96.9 %)

kmeans_iyer(test3,5)
# Within cluster sum of squares by cluster:
#[1] 31.10798 15.51408 19.82691 71.30005 13.61199
#(between_SS / total_SS =  97.4 %)


#K=7
kmeans_iyer(train3,7)
#K-means clustering with 7 clusters of sizes 970, 657, 1286, 1209, 442, 348, 774

#Within cluster sum of squares by cluster:
#[1]  41.013231 261.405552  26.759911  77.753726   9.889200   9.529402   9.793614
#(between_SS / total_SS =  97.7 %)

kmeans_iyer(test3,7)
#Within cluster sum of squares by cluster:
#[1] 15.373458 16.278637  8.762891 10.027488 10.493603 17.520052 11.993597
